...
#ifndef EVENT_SIMTRIGGERPADHIT_H_
#define EVENT_SIMTRIGGERPADHIT_H_
...
namespace ldmx {
    ...
    /**
     * @class SimTriggerPadHit
     * @brief Represents a simulated triggerpad hit in the simulation
     */
    class SimTriggerPadHit: public TObject {
        ...
        public:
            ...
            /**
             * Reset the SimTriggerPadHit object.
             */
            ...
            int getLayerID() const { return layerID_; };
             ...
             /**
             * Get the geometric strip ID of the hit.
             * @return The strip ID of the hit.
             */
            int getStripID() const { return stripID_; };

            /** 
             * Get the pad ID associated with a hit.
            ...
            /**
             * Set the geometric strip ID of the hit.
             * @param stripID The strip ID of the hit.
             */
            void setStripID(const int stripID) { this->stripID_ = stripID; };
...
#endif // EVENT_SIMTRIGGERPADHIT_H_
