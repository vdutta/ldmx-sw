...
namespace ldmx {
    ...
    G4bool HcalSD::ProcessHits(G4Step* aStep, G4TouchableHistory* ROhist) {
        ...
        else if (section==HcalSection::TOP || section==HcalSection::BOTTOM) stripID = int( (localPosition.z()+scint->GetZHalfLength())/100.0);
        else if (section==HcalSection::LEFT || section==HcalSection::RIGHT) stripID = int( (localPosition.z()+scint->GetZHalfLength())/100.0);
