/**
 * @file HcalCosmicMuonTriggerProducer.cxx
 * @brief Implementaiton of HcalCosmicMuonTriggerProducer class
 * @author Tom Eichlersmith, University of Minnesota
 */

#include "Hcal/HcalCosmicMuonTriggerProducer.h"

namespace ldmx {

    void HcalCosmicMuonTriggerProducer::configure(const ldmx::ParameterSet& ps) {
        ...
        triggerObjectName_ = ps.getString( "HcalCosmicMuonTriggerObjectName" );
    ...
    void HcalCosmicMuonTriggerProducer::produce(ldmx::Event& event) {
        ...
        for ( int corient = 0; corient < 6; corient++ ) {
            ...
            while ( findEndPoints( corient ) ) {
                ...
                if ( corient > 1 and abs(dlayer) > 0 ) {
                    //use layers as independent variable in SIDE HCAL
                    ...
                    //use strips as independent variable in BACK HCAL (cosmics from above)
    ...
    void HcalCosmicMuonTriggerProducer::onProcessEnd() {
        
        printf( "\n" );
        printf( " ============================================\n" );
        printf( " |      HcalCosmicMuonTriggerProducer       |\n" );
        printf( " |==========================================|\n" );
    ...
    bool HcalCosmicMuonTriggerProducer::isPlausibleMip( ldmx::HcalHit* hit ) const {
        return ( hit->getPE() > minPE_ and hit->getEnergy() < maxEnergy_ );
    }

    bool HcalCosmicMuonTriggerProducer::findEndPoints( int orientation ) {
...
DECLARE_PRODUCER_NS( ldmx , HcalCosmicMuonTriggerProducer );
