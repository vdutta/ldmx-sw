...
namespace ldmx {
    ...
    void HcalHitMatcher::onFileOpen() {
	std::cout << "HcalHitMatcher: Opening a file!" << std::endl;   
    }

    void HcalHitMatcher::onFileClose() {
	std::cout << "HcalHitMatcher: Closing a file!" << std::endl;
    }
	...
	std::cout << "HcalHitMatcher: Finishing processing!" << std::endl;
    }
