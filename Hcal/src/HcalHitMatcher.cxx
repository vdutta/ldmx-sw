...
namespace ldmx {
    ...
    void HcalHitMatcher::analyze(const ldmx::Event& event) {
        ...
        int ecal_sumESD = 2; //Labels what approximate standard deviation range the summed ecal energy is
        if ( e_cal_sum_energy > (3963 + 409.8) )        ecal_sumESD = 1; //HI range
        else if ( e_cal_sum_energy < (3963 - 409.8) )   ecal_sumESD = 3; //LOW range
        else                                            ecal_sumESD = 2; //MID range

        //Bin event information
        h_E_cal_summed_energy_SD[0]->Fill(e_cal_sum_energy);
        h_E_cal_summed_energy_SD[ecal_sumESD]->Fill(e_cal_sum_energy);
    
        h_total_particles_SD[0]->Fill(ecalScoringPlaneSimParticles.size());
        ...
        for(int iHit=0; iHit < numHcalSimHits; iHit++) {
            ...
            h_ZdepthofHCalHit_SD[0]->Fill( hitZ );
            h_ZdepthofHCalHit_SD[ecal_sumESD]->Fill( hitZ );

            h_hcal_hit_time_all_SD[0]->Fill( hitTime );
...
//            h_hcal_hits_all_PEs_SD[0]->Fill(hcalhit->getPE());
...
//                    h_part_hCalhit_tdif_great40_PE_SD[ecal_sumESD]->Fill(hcalhit->getPE());
                ...
                switch(particlePDG) {
                    ...
                    case 2112:
                        ...
                        h_HCalhit_neutron_zbyr_SD[0]->Fill(hitZ, hcalhit_radialdist); 
                        break;
                    default:
                        h_HCalhit_other_zbyr_SD[0]->Fill(hitZ, hcalhit_radialdist); 
                ...
                h_HCalhit_unmatched_zbyr_SD[0]->Fill(hitZ, hcalhit_radialdist);
...
//        h_hcal_hits_max_PE_of_event_SD[0]->Fill(max_PE_of_event);
//        h_hcal_hits_max_PE_of_event_SD[ecal_sumESD]->Fill(max_PE_of_event);
    ...
    void HcalHitMatcher::onProcessStart() {
        ...
        std::vector<std::string> range_names(4);
        range_names[0] = "ALL";
        range_names[1] = "HI";
        range_names[2] = "MID";
        range_names[3] = "LOW";
