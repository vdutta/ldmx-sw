/**
 * @file HcalCosmicMuonTriggerProducer.h
 * @brief Header file for HcalCosmicMuonTriggerProducer
 * @author Tom Eichlersmith, University of Minnesota
 */

#ifndef HCAL_HCALCOSMICMUONTRIGGERPRODUCER_H
#define HCAL_HCALCOSMICMUONTRIGGERPRODUCER_H
...
namespace ldmx {
    ...
    /**
     * @class HcalCosmicMuonTriggerProducer
     ...
     * passes this trigger.
     */
    class HcalCosmicMuonTriggerProducer : public ldmx::Producer {
        public:

            HcalCosmicMuonTriggerProducer(const std::string& name, ldmx::Process& process) 
...
#endif /* HCAL_HCALCOSMICMUONTRIGGERPRODUCER_H */
